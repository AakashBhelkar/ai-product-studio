      ...
      <div className="relative container mx-auto px-6">
        ...
        <div className="max-w-5xl mx-auto space-y-8">
          {experiences.map((exp, index) => (
            <div 
              key={index}
              className="relative pl-12 border-l-4 border-electric-purple/30 pb-8 last:pb-0 group"
            >
              <div className="absolute -left-[13px] top-0 w-6 h-6 rounded-full bg-gradient-primary shadow-glow group-hover:scale-125 transition-transform duration-300" />
              
              <div className="bg-card border border-border/50 rounded-2xl p-8 shadow-card hover:shadow-card-hover transition-all duration-500 hover:border-electric-purple/30 backdrop-blur-sm">
                <div className="mb-6">
