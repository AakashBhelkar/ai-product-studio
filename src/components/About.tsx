...
const About = () => {
  return (
    <section className="relative py-16 sm:py-24 md:py-32 bg-gradient-to-b from-background via-card/30 to-background overflow-hidden">
      ...
      <div className="absolute top-0 left-1/4 w-64 h-64 md:w-96 md:h-96 bg-electric-purple/5 rounded-full blur-3xl" />
      <div className="absolute bottom-0 right-1/4 w-64 h-64 md:w-96 md:h-96 bg-neon-blue/5 rounded-full blur-3xl" />
      ...
      <div className="relative container mx-auto px-4 sm:px-6">
        ...
        <div className="max-w-5xl mx-auto">
          <Card className="border-border/50 shadow-card hover:shadow-card-hover transition-all duration-500 bg-gradient-card backdrop-blur-sm mb-8 sm:mb-12">
